...
for j in list(range(70, 71, 2)):
    ...
    for i in range(5):
        ...
        history_dict = {}
        chat(model=model,tokenizer=tokenizer,prompts=prompts,batch_size = 2,max_new_tokens=64,history_dict=history_dict,device=device0)
...
with open('full_copy_1_1.txt', 'w') as file:
    file.write(f"==============llama2-13b bs = 2===================\n")
    #file.write(f"xlabel = {list(range(91, 151, 2))}\n")
